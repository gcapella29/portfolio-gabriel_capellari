...
function CommerceEditorialTemplate({project,data}:TemplateRenderProps){
 ...
 const socialImages=[...galleryImages,'/commerce/commerce-hero.png','/commerce/commerce-feature.png','/commerce/commerce-menu.png','/commerce/commerce-feature.png','/commerce/commerce-menu.png','/commerce/commerce-hero.png'].slice(0,6);
