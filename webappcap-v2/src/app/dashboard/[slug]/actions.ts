...
export async function saveContentAction(formData:FormData){
 ...
 const contact={...current.contact,email:text(formData,'email'),phone:text(formData,'phone'),whatsapp:text(formData,'whatsapp'),instagram:text(formData,'instagram'),address:text(formData,'address'),hours:text(formData,'hours')};
 if(portfolio)Object.assign(contact,{email_alt:text(formData,'email_alt'),whatsapp_label:text(formData,'whatsapp_label'),linkedin:text(formData,'linkedin'),cv:text(formData,'cv'),reel:text(formData,'reel')});
