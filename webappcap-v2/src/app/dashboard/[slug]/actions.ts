...
const commerceTextKeys=['nav_home','nav_news','nav_highlights','nav_menu','nav_order','hero_kicker','hero_whatsapp','hero_instagram','hero_discover','news_kicker','news_title','news_intro','news_link','highlights_kicker','highlights_title','highlights_intro','highlight_label','highlights_link','menu_kicker','menu_title','menu_intro','menu_selected_label','menu_add','menu_whatsapp_cta','order_kicker','order_title','order_intro','receipt_kicker','receipt_title','receipt_empty','receipt_total','receipt_send','receipt_choose','receipt_notice','social_kicker','social_title','social_intro','social_follow','about_kicker','about_title','about_main','creator_name','creator_bio','footer_back'] as const;
