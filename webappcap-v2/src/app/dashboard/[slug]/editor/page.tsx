...
export default async function TemplateEditorPage({params,searchParams}:{params:Promise<{slug:string}>;searchParams:Promise<{template?:string;savedAppearance?:string;savedContent?:string}>}){
 ...
 const appearance={accent:color(v(data.appearance,'accent')),scale:v(data.appearance,'scale')||'normal',headingFont:v(data.appearance,'heading_font')||'Montserrat',bodyFont:v(data.appearance,'body_font')||'DM Sans',alignment:v(data.appearance,'alignment')||'left',density:v(data.appearance,'density')||'normal',supportFont:v(data.appearance,'support_font'),supportSize:v(data.appearance,'support_size')||'14',supportBold:v(data.appearance,'support_bold')==='true',supportItalic:v(data.appearance,'support_italic')==='true',buttonFont:v(data.appearance,'button_font'),buttonSize:v(data.appearance,'button_size')||'12',buttonBold:v(data.appearance,'button_bold')!=='false',buttonItalic:v(data.appearance,'button_italic')==='true'};
