...
type AppearanceValues={accent:string;scale:string;alignment:string;density:string;supportSize?:string;supportBold?:boolean;supportItalic?:boolean;buttonSize?:string;buttonBold?:boolean;buttonItalic?:boolean};
